...
package com.example.gleb.mailmanager.filedialog;
...
class FileChooserCore {
	...
	private View.OnClickListener addButtonClickListener = new View.OnClickListener() {
		public void onClick(View v) {
			...
			String title = context.getString(FileChooserCore.this.folderMode? R.string.dialog_create_folder : R.string.dialog_create_file);
			...
			String message = context.getString(FileChooserCore.this.folderMode? R.string.dialog_enter_folder_name : R.string.dialog_enter_file_name);
			...
			String posButton = (FileChooserCore.this.labels != null && FileChooserCore.this.labels.createFileDialogAcceptButton != null)? FileChooserCore.this.labels.createFileDialogAcceptButton : context.getString(R.string.dialog_accept);
			String negButton = (FileChooserCore.this.labels != null && FileChooserCore.this.labels.createFileDialogCancelButton != null)? FileChooserCore.this.labels.createFileDialogCancelButton : context.getString(R.string.dialog_cancel);
		...
		if((creation && this.showConfirmationOnCreate || !creation && this.showConfirmationOnSelect)) {
			...
			if(FileChooserCore.this.labels != null && ((creation && FileChooserCore.this.labels.messageConfirmCreation != null) || (!creation && FileChooserCore.this.labels.messageConfirmSelection != null)))  {
				...
				if(FileChooserCore.this.folderMode) {
					message = context.getString(creation? R.string.dialog_confirm_create_folder : R.string.dialog_confirm_select_folder);
				} else {
					message = context.getString(creation? R.string.dialog_confirm_create_file : R.string.dialog_confirm_select_file);
				}
			}
			if(message != null) message = message.replace("$file_name", name!=null? name : file.getName());
			String posButton = (FileChooserCore.this.labels != null && FileChooserCore.this.labels.labelConfirmYesButton != null)? FileChooserCore.this.labels.labelConfirmYesButton : context.getString(R.string.dialog_yes);
			String negButton = (FileChooserCore.this.labels != null && FileChooserCore.this.labels.labelConfirmNoButton != null)? FileChooserCore.this.labels.labelConfirmNoButton : context.getString(R.string.dialog_no);
